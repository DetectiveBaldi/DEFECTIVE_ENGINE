...
class Week1 extends Stage<FlxBasic>
{
    ...
    public function new():Void
    {
        ...
        background = new FlxSprite(0, 0, AssetManager.graphic(Paths.png("assets/images/stages/week1/background")));

        background.screenCenter();

        members.push(background);

        foreground = new FlxSprite(0, 0, AssetManager.graphic(Paths.png("assets/images/stages/week1/foreground")));
        ...
        curtains = new FlxSprite(0, 0, AssetManager.graphic(Paths.png("assets/images/stages/week1/curtains")));
